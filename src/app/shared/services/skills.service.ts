...
export class SkillsService {
  private readonly skills: Skill[] = [
    ...
    { label: 'Python', icon: 'assets/icon/skill-icon/python_icon.png' },
    { label: 'Django', icon: 'assets/icon/skill-icon/django_icon.png' },
    { label: 'PostgreSQL', icon: 'assets/icon/skill-icon/postgresql_icon.png' },
    { label: 'Docker', icon: 'assets/icon/skill-icon/docker_icon.png' },
